...
<div class="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4 bg-green-500 text-white">
    <div>
...
<template>
    ...
    <footer
        class="bg-green-500 w-full pt-5 md:pt-10 lg:pt-20 sm: pb-0 px-10 md:px-20 lg:px-30 xl:px-96 ml-auto mr-auto text-neutral-50">
        <div
            class="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 sm:gap-auto md-gap:2 lg:gap-auto pb-5 md:pb-10 lg:pb-10 px-0 py-0 ">
            <div class="sm:col-span-2 md:col-span-2 lg:col-auto">
                <h2
                    class="font-semibold md:font-semibold lg:font-normal text-white mb-6 sm:text-2xl md:text-2xl lg:text-xl mb-4">
                    About</h2>
                <p class="text-whitetext-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur
            ...
            <div class="md:pb-10 sm:pb-10 ">
                <h2
                    class="font-semibold md:font-semibold lg:font-normal text-white mb-6 sm:text-2xl md:text-2xl lg:text-xl mb-4 pt-10 md:pt-5 lg:pt-0">
                    Quick Links</h2>
        ...
        <div class="text-center px-4 pb-8 pt-12 border-t border-white border-opacity-10 border-neutral-100">
            <span
                class="text-sm  font-normal mb-4 mt-0font-semiboldtext-whitetext-gray-500 dark:text-gray-400">Copyright
                &copy; 2023 All rights reserved by
                <a class="font-bold" href="https://colorlib.com" target="_blank">Sadbhavna DonetKart ❤️
                    <!--<svg class="w-4 h-4 text-red-500 fill-current" viewBox="0 0 24 24" aria-hidden="true"><path d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" clip-rule="evenodd" /></svg>--></a>
            </span>
